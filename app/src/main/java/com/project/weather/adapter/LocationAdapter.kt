package com.project.weather.adapter
...
import com.project.weather.view.DetailsActivity
...
class LocationAdapter(private val context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.rv_location_child,parent,false))
    }
